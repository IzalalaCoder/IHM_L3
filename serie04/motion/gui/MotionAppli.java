...
public class MotionAppli {
    ...
    private void createController() {
        ...
        /*****************/
        /** A COMPLETER **/
        for (BKey btn : BKey.values()) {
        	buttons.get(btn).addActionListener(new ActionListener() {

				@Override
				public void actionPerformed(ActionEvent e) {
					btn.executeCommand(animator);
				}
        ...
        /*****************/
        /** A COMPLETER **/
        this.animator.addChangeListener(new ChangeListener() {
    ...
    private void updateButtons() {
        ...
        /** A COMPLETER **/
        for (BKey btn : BKey.values()) {
        	buttons.get(btn).setEnabled(btn.enabledValue(animator));
        }
        /*****************/
    }
